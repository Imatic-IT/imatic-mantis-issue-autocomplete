...
const issueResponseSchema = zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
    id: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
    summary: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
    project: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
    status: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
    statusColor: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
});
const settingsSchema = zod__WEBPACK_IMPORTED_MODULE_1__.z.object({
    url: zod__WEBPACK_IMPORTED_MODULE_1__.z.string(),
});
class Issue {
    constructor() {
        this.searchValue = '';
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            this.settings = settingsSchema.parse((0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__.getSettings)());
        });
    }
    fetchIssues() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    searchIssues(value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.issues = yield this.fetchIssues();
            return this.issues;
        });
    }
}
...
/***/ "./src/components/IssueWhisperer.ts":
/*!******************************************!*\
  !*** ./src/components/IssueWhisperer.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IssueWhisperer: () => (/* binding */ IssueWhisperer)
/* harmony export */ });
/* harmony import */ var _Issue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Issue */ "./src/components/Issue.ts");
...
/* harmony import */ var lit_html_directives_unsafe_html_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lit-html/directives/unsafe-html.js */ "./node_modules/lit-html/development/directives/unsafe-html.js");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const settingsSchema = zod__WEBPACK_IMPORTED_MODULE_5__.z.object({
    autocompleteIssueWindowSettings: zod__WEBPACK_IMPORTED_MODULE_5__.z.record(zod__WEBPACK_IMPORTED_MODULE_5__.z.string()),
    minSearchLength: zod__WEBPACK_IMPORTED_MODULE_5__.z.number(),
    minSearchLengthMessage: zod__WEBPACK_IMPORTED_MODULE_5__.z.string(),
    noIssueFoundMessage: zod__WEBPACK_IMPORTED_MODULE_5__.z.string(),
    searchForIssueMessage: zod__WEBPACK_IMPORTED_MODULE_5__.z.string(),
    searchInputNames: zod__WEBPACK_IMPORTED_MODULE_5__.z.array(zod__WEBPACK_IMPORTED_MODULE_5__.z.string()),
    fieldSeparator: zod__WEBPACK_IMPORTED_MODULE_5__.z.string(),
    submitOnSelect: zod__WEBPACK_IMPORTED_MODULE_5__.z.boolean(),
});
class IssueWhisperer {
    constructor() {
        ...
        this.onInput = (event) => __awaiter(this, void 0, void 0, function* () {
            this.show();
            ...
            if (value.length < this.settings.minSearchLength) {
                ...
                const issue = new _Issue__WEBPACK_IMPORTED_MODULE_0__.Issue();
                const issues = yield issue.searchIssues(value);
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            this.settings = settingsSchema.parse((0,_utils_utils__WEBPACK_IMPORTED_MODULE_1__.getSettings)());
    ...
    initializeSearchInputs() {
        const searchInputSettings = this.settings.searchInputNames.concat('issue-search-input');
        searchInputSettings.forEach(name => {
            const inputs = Array.from(document.querySelectorAll(`input[name="${name}"]`));
            inputs.forEach((input) => {
                input.addEventListener('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(this.onInput, 300));
    ...
    renderIssues(issues) {
        ...
        const template = (0,lit_html__WEBPACK_IMPORTED_MODULE_2__.html) `
            ...
            ? issues.map(issue => {
                ...
                return (0,lit_html__WEBPACK_IMPORTED_MODULE_2__.html) `
                        <li class="issue-item ${isHighlighted ? 'issue-highlighted' : ''}">
                            <button class="issue-button fa fa-external-link"
                                    data-id="${issue.id}">
                            </button>

                            <span>${(0,lit_html_directives_unsafe_html_js__WEBPACK_IMPORTED_MODULE_4__.unsafeHTML)(this.settings.fieldSeparator)}</span>
            ...
            : (0,lit_html__WEBPACK_IMPORTED_MODULE_2__.html) `
                    <li class="no-issues-item">${this.settings.noIssueFoundMessage}</li>`}
        `;
        (0,lit_html__WEBPACK_IMPORTED_MODULE_2__.render)(template, this.issueListElement);
    }
    createListIssuesOverlay() {
    ...
    destroy() {
        ...
        searchInputSettings.forEach(name => {
            const inputs = Array.from(document.querySelectorAll(`input[name="${name}"]`));
            inputs.forEach((input) => {
                input.removeEventListener('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(this.onInput, 300));
            });
        });
...
function getSettings() {
    const el = document.querySelector("#imaticWhisperer");
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_IssueWhisperer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/IssueWhisperer */ "./src/components/IssueWhisperer.ts");

(function () {
    let issueWhisperer = null;
    issueWhisperer = new _components_IssueWhisperer__WEBPACK_IMPORTED_MODULE_0__.IssueWhisperer();
