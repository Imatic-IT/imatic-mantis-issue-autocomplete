...
/***/ "./src/components/IssueAutocomplete.ts":
/*!*********************************************!*\
  !*** ./src/components/IssueAutocomplete.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IssueAutocomplete: () => (/* binding */ IssueAutocomplete)
/* harmony export */ });
...
const settingsSchema = zod__WEBPACK_IMPORTED_MODULE_4__.z.object({
    autocomplete_issue_window_settings: zod__WEBPACK_IMPORTED_MODULE_4__.z.record(zod__WEBPACK_IMPORTED_MODULE_4__.z.string()),
    min_search_length: zod__WEBPACK_IMPORTED_MODULE_4__.z.number(),
    min_search_length_message: zod__WEBPACK_IMPORTED_MODULE_4__.z.string(),
    no_issue_found_message: zod__WEBPACK_IMPORTED_MODULE_4__.z.string(),
    search_for_issue_message: zod__WEBPACK_IMPORTED_MODULE_4__.z.string(),
});
class IssueAutocomplete {
    constructor() {
        this.originalInputName = 'dest_bug_id';
        this.clonedInputId = 'issue-autocomplete';
        ...
        this.onIssueClick = (event) => {
            const button = event.target.closest('.issue-button');
            if (button) {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.originalInput = document.querySelector(`input[name="${this.originalInputName}"]`);
            this.cloneInputElement();
            this.createListIssuesOverlay();
            this.clonedInput.addEventListener('input', lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(this.onInput, 300));
    ...
    cloneInputElement() {
        if (this.originalInput) {
            this.clonedInput = this.originalInput.cloneNode(true);
    ...
    renderIssues(issues) {
        const template = (0,lit_html__WEBPACK_IMPORTED_MODULE_2__.html) `
            ${issues.length > 0
            ? issues.map(issue => (0,lit_html__WEBPACK_IMPORTED_MODULE_2__.html) `
                        <li class="issue-item">
    ...
    setRelatedIssueIdIntoTheInput(issueId) {
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_IssueAutocomplete__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/IssueAutocomplete */ "./src/components/IssueAutocomplete.ts");

(function () {
    let issueAutocomplete = null;
    issueAutocomplete = new _components_IssueAutocomplete__WEBPACK_IMPORTED_MODULE_0__.IssueAutocomplete();
